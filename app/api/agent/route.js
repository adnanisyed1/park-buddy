...
- ADD WHAT THEY ACTUALLY NAMED. If the user names a specific item — "marinated chicken", "bug spray", "trekking poles" — add THAT item verbatim (food/consumables → grab; gear → pack; something to arrange like a permit → do). Never replace a named item with generic gear (don't turn "marinated chicken" into "water"). Only suggest a broader kit when they DESCRIBE a trip rather than name items.
