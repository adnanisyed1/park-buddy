...
(function () {
  ...
  // The Park Buddy brand mark used everywhere: the parchment "THE PARK BUDDY" badge
  // (see app/components/SiteHeader.jsx Logo — same /brand asset, matches 1:1).
  function pineSvg(px) {
    return '<img src="/brand/the-park-buddy-badge.png" alt="The Park Buddy" width="' + px + '" height="' + px + '" style="width:' + px + 'px;height:' + px + 'px;object-fit:contain;display:block" />';
  }
  ...
  function css() {
    ...
    s.textContent =
      ...
      '.pbask-fab .pbask-mark{width:26px;height:26px;flex:none;display:flex;align-items:center;justify-content:center;filter:drop-shadow(0 2px 8px rgba(0,0,0,.4))}' +
